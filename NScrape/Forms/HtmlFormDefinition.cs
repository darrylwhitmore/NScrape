...
public class HtmlFormDefinition {
	...
	private readonly List<HtmlFormControl> controls = new();
	...
	/// </summary>
	public ReadOnlyDictionary<string, string> Attributes => new( attributes );

	/// <summary>
	/// Gets the controls contained within the HTML form.
	/// </summary>
	public IEnumerable<HtmlFormControl> Controls => controls;
	...
	/// </remarks>
	public string Id => Attributes.ContainsKey( "id" ) ? Attributes["id"] : null;
