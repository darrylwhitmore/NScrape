...
//		protected string Text { get { return text ?? ( text = webResponse.GetResponseText() ); } }
		...
		protected string Text {
			get {
				...
				//return text ?? ( text = webResponse.GetResponseText() );

				using ( var reader = new System.IO.StreamReader( webResponse.GetResponseStream() /*, encoding*/ ) ) {  / need encoding (see skeet answer: https://stackoverflow.com/questions/3273205/read-text-from-response)
